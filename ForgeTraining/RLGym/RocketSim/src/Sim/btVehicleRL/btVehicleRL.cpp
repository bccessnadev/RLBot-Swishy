...
namespace {
	bool reuseWheelTransformsInUpdateVehicleFirst = true;
}
...
void btVehicleRL::SetReuseWheelTransformsInUpdateVehicleFirst(bool enabled) {
	reuseWheelTransformsInUpdateVehicleFirst = enabled;
}

bool btVehicleRL::GetReuseWheelTransformsInUpdateVehicleFirst() {
	return reuseWheelTransformsInUpdateVehicleFirst;
}
...
float btVehicleRL::rayCast(btWheelInfoRL& wheel, bool updateTransforms) {
	if (updateTransforms)
		updateWheelTransformsWS(wheel);
...
void btVehicleRL::updateVehicleFirst(float step) {
	const bool updateTransformsBeforeRayCast = !reuseWheelTransformsInUpdateVehicleFirst;
	...
	for (int i = 0; i < m_wheelInfo.size(); i++)
		rayCast(m_wheelInfo[i], updateTransformsBeforeRayCast);
