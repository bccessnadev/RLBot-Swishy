...
public:
	...
	static void SetReuseWheelTransformsInUpdateVehicleFirst(bool enabled);
	static bool GetReuseWheelTransformsInUpdateVehicleFirst();
	...
	float rayCast(btWheelInfoRL& wheel, bool updateTransforms = true);
